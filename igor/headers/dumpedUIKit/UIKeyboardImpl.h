...
@class UIAutocorrectInlinePrompt, NSString, UIKeyboardLayout, UIKeyboardInputManager, UIDelayedAction, NSMutableDictionary, UITextInputTraits, UIKeyboardLanguageIndicator, NSArray, NSTimer, CandWord;
