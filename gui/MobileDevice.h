...
mach_error_t AMDeviceStartHouseArrestService(struct am_device *device, CFStringRef identifier, void *unknown, afc_connection **handle, unsigned int *what);
...
mach_error_t AMDPostNotification(void *socket, CFStringRef  notification, CFStringRef userinfo);
